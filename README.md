...
- Desktop builds can compile with the selected local TeX runtime and per-project engine selection through bounded Tauri commands; browser builds continue to use the HTTP fallback compiler.
