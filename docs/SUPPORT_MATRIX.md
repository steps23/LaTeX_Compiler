...
Prompt 5/6 baseline adds local TeX runtime diagnostics, selected-runtime persistence, per-project overrides and a bounded desktop local compile command. CI covers fixture-based detection and compile-command contract behavior across macOS, Windows and Linux. Local macOS CLI smoke verifies a real TeX Live 2025 toolchain can compile a fixture PDF, but installed-app compile smoke and real local compilation on Windows/Linux remain pending.
