    ...
    <div className="w-screen h-screen bg-zinc-950 text-zinc-200 flex flex-col font-sans overflow-hidden">
      <header className="h-16 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-6 shrink-0">
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={() => navigate("/tex-environment")}
            className="text-sm font-medium text-zinc-300 hover:text-white transition-colors bg-zinc-800/70 hover:bg-zinc-800 px-3 py-1.5 rounded-md border border-zinc-700 flex items-center gap-2"
          >
